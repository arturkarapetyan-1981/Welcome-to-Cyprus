...
const Footer = () => {
  ...
  return (
    <footer className="bg-[var(--mid-teal)] text-white py-10 mt-20">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <Link href={`/?lang=${lang}`} className="hover:underline text-gray-300">
                {t.home}
              </Link>
            </li>
            <li>
              <Link href={`/services?lang=${lang}`} className="hover:underline text-gray-300">
                {t.services}
              </Link>
            </li>
            <li>
              <Link href={`/blog?lang=${lang}`} className="hover:underline text-gray-300">
                {t.blog}
              </Link>
            </li>
            <li>
              <Link href={`/contact?lang=${lang}`} className="hover:underline text-gray-300">
                {t.contact}
              </Link>
            </li>
            <li>
              <Link href={`/about?lang=${lang}`} className="hover:underline text-gray-300">
                {t.about}
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <p className="text-sm text-white">
            {t.email}:{" "}
            <a href="mailto:info@cyprus.com" className="hover:underline">
              info@cyprus.com
            </a>
          </p>
          <p className="text-sm text-white mt-2">
            {t.phone}:{" "}
            <a href="tel:+35712345678" className="hover:underline">
              +357 12 345678
            </a>
          </p>
        </div>
