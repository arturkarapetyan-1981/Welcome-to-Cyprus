...
export default function BecomePartner() {
  ...
  useEffect(() => {
    const fetchTranslation = async () => {
      try {
        const res = await fetch('/data/partner.json');
  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between p-6 md:p-12 bg-white shadow-lg rounded-2xl max-w-6xl mx-auto my-12">
      {/* Image */}
